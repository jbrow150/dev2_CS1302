 ...
 * @version Fall 2025
 */
public class DescendingByPriorityThenName implements Comparator<Task> {
	...
	public int compare(Task o1, Task o2) {
		...
		int priorityCompare = Integer.compare(o2.getPriority().getValue(), o1.getPriority().getValue());
	...
	public String toString() {
		return "Descending by Priority then Name";
	}
}